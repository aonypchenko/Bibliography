  ...
  <div class="container col-xxl-8 px-4 py-5">
      <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div class="col-lg-6">
          ...
          <p class="lead">Система збереження та обробки бібліографічної інформації. Бібліографічна інформація надає пошуку інформаційних джерел більшої ефективності, дає змогу однозначно ідентифікувати їх та виконує роль посередника між джерелами та користувачем.</p>
