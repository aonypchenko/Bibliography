...
?>
  ...
  ?>
  <nav class="d-inline-flex mt-2 mt-md-0 ms-md-2">
  <button type="button" name="exit_user" class="btn btn-light me-md-3" onclick="redirect_to_addpubl()">Додати публікацію</button>
  </nav>
  <nav class="d-inline-flex mt-2 mt-md-0 ms-md-2">
  <button type="button" name="exit_user" class="btn btn-light me-md-3" onclick="redirect_to_mypubl()">Мої публікації</button>
  </nav>
  <nav class="d-inline-flex mt-2 mt-md-0 ms-md-2">
