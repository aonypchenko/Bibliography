...
?>
  <button type="button" class="btn btn-primary" onclick="window.location.href='../sign_in/html-registration.php'">Реєстрація</button>
  ...
  <nav class="d-inline-flex mt-2 mt-md-0 ms-md-2">
  <form method="post" action="../sign_in/exit.php">
